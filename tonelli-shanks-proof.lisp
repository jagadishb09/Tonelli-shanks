  ...
  (local
   (defthm T-s-aux-=T-s-aux
     (implies (and (posp n)
                   (posp z)
                   (posp S))
              (equal (T-S-aux-= n z S M c tt R p)
                     (T-S-aux M c tt R p)))
     :hints (("Goal"
...
;;   :hints (("Goal"
;;            :use (:instance T-s-aux-=T-s-aux (n n) (z z) (S (MV-NTH 1 (Q*2^S (+
;;                                                                              -1 P))))
